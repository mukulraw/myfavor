...
public class MyActivity extends AppCompatActivity implements PlaceSelectionListener {
...
//        });
    ...
    void getFavlist() {
        ...
        String url = "http://mrfavor.in/myfavour/fav_route_piclocation.php";
...
//                                .setAction("No action", null).show();
    ...
    public void onPlaceSelected(@NonNull Place place) {
        ...
        pick = place.getAddress();

        //Log.d("placee" , place.getAddress());
