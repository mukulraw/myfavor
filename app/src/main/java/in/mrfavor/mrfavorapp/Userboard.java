        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                }else
                {
                    ...
                    {
                        Toast.makeText(Userboard.this, "Please select a drop location", Toast.LENGTH_SHORT).show();
                    }
...
*/
        ...
        MenuItem nav_login = menu.findItem(R.id.version);
        ...
        try {
            ...
            nav_login.setTitle("Version " + versionName);
...
//            ft.commit();
    ...
    void addFav() {
        ...
        String url = "http://mrfavor.in/myfavour/fav_route_add.php";
    ...
    private void termandconditions() {
        ...
        Intent intent = new Intent(Userboard.this , Terms.class);
...
//
    void getFavlist4() {
        SharedPreferences pref = getApplicationContext().getSharedPreferences("Logininfo", Context.MODE_PRIVATE);
        userid = pref.getString("useremail", null);
        StringRequest MyStringRequest = new StringRequest(Request.Method.POST, "http://mrfavor.in/myfavour/ride_status_customer.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
